    ...
    public void run() {
        ...
        for (Upload upload : uploads) {
            ...
            try {
                ...
                List<FileInfo> fileInfoList = FileUtil.getCOrCppFilesName(directoryPath);
...
//                            String outputFilePath = fatherFilePath + "/" + outputFileName;
//                            if (FileUtil.compareFileWithString(outputFilePath, testCase.getAnswer())) {
//                                testCasePassNum++;
//                            }
//                        }
...
//                        String evaluateFilePath = fatherFilePath + "/" + question.getQuestionNo() + "_result.json";
//                        String json = FileUtil.readFile(evaluateFilePath);
//                        OclintInfoVo info = JSON.parseObject(json, OclintInfoVo.class);
//                        int evaluationScore = 30;
//                        List<Integer> violationIdList = new ArrayList<>();
...
//            } catch (Exception e) {
//                LogKit.error(e.getMessage());
//                assignmentService.update(assignment.getAssignmentId(), -1);
//            }
//        }
//
//    }
