 ...
 */
public class ActionExceptionIntoLogInterceptor implements Interceptor {

    private static final Logger log = Logger.getLogger(ActionExceptionIntoLogInterceptor.class);
