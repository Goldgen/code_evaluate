...
public class ServiceExceptionIntoLogInterceptor implements Interceptor {

    private static final Logger log = Logger.getLogger(ServiceExceptionIntoLogInterceptor.class);
