...
protected:
	...
	int recursive_height(AVL_node *sub_root)const;
...
{
    if(sub_root==NULL||sub_root->right==NULL) cout<<"Error in rotate_left"<<endl;
    else{
...
{
    if(sub_root==NULL||sub_root->left==NULL) cout<<"Error in rotate_right"<<endl;
    else{
...
void AVL_tree::right_balance(AVL_node *&sub_root)
{
    ...
    {
    case equal_height:
        cout<<"Error in left_balance"<<endl;
        break;
    case right_higher:
...
void AVL_tree::left_balance(AVL_node *&sub_root)
{
    ...
    {
    case equal_height:
        cout<<"Error in right_balance"<<endl;
        break;
    case left_higher:
