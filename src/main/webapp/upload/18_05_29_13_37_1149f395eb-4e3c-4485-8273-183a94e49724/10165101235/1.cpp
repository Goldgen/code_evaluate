...
enum Error_code{notPresent,overflow,underflow,duplicateError/*chongfu*/,success};
...
Error_code AVL_tree::avl_insert(AVL_node *&sub_root,const Entry &new_data,bool &taller)
{
    ...
    else if(new_data<sub_root->data){  //insert in left tree{
...
void AVL_tree::rotate_left(AVL_node *&sub_root){  //right taller than left one
...
void AVL_tree::rotate_right(AVL_node *&sub_root){  //left taller than right one
